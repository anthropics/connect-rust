...
include!("grpc.reflection.v1alpha.reflection.rs");
#[allow(
...
pub mod __buffa {
    ...
    pub mod view {
        #[allow(unused_imports)]
        use super::*;
        include!("grpc.reflection.v1alpha.reflection.__view.rs");
        pub mod oneof {
            #[allow(unused_imports)]
            use super::*;
            include!("grpc.reflection.v1alpha.reflection.__view_oneof.rs");
        }
    }
    pub mod oneof {
        #[allow(unused_imports)]
        use super::*;
        include!("grpc.reflection.v1alpha.reflection.__oneof.rs");
    }
